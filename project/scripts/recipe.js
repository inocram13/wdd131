...
// JavaScript for Recipe Homepage
...
headerContainer.insertBefore(navToggle, headerContainer.firstChild);
...
document.querySelectorAll('.btn-small').forEach(button => {
    button.addEventListener('click', (e) => {
        e.preventDefault();
        const recipeName = button.previousElementSibling.textContent;
        const modal = document.getElementById('recipe-modal');
        modal.querySelector('.modal-content h3').textContent = recipeName;
